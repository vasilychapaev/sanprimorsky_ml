                ...
                <div id="header-form" class="col-lg-6 col-md-7 col-sm-8">
                    <div class="forma text-center">
                        ...
                        <div class="form-title-before">
                            <img src="/old/img/var5.jpg" alt="акция санатория Приморский">
                        </div>
                        <form class="form">
...
<div class="section calc">
    <div class="container">
        <h2 class="text-center">
            Хотите подобрать программу отдыха исходя из ваших заболеваний?
        </h2>
        <div class="calc-form">
            <form class="form">
                ...
                <div class="form-container leto text-center">
                    <div class="title">
                        Выберите параметры и <span>получите рекомендованную программу
                            Вашего отдыха со стоимостью</span>:
                    </div>
                    ...
                    <div id="step-five" class="step">
                        ...
                        <div class="buttons">
                            ...
                            <div class="clearfix"></div>
                            <div class="info">
                                Мы свяжемся с Вами в течение 20 минут по указанному номеру телефона
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 col-md-7 col-sm-8">
                <div class="forma text-center">
                    <div class="form-title">Успейте сэкономить! Бронирование 2019!</div>
                    <div class="form-title-before">
                        <img src="/old/img/var5.jpg" alt="Акция в санатории Приморский">
                    </div>
                    <form class="form">
...
<div class="modal fade" id="global-modal" role="dialog" >
    <div class="modal-dialog modal-lg" style="top: 5%;padding-left: 8%; padding-right: 8%;">
        <!--Modal Content-->
        <div class="modal-content" style="background-image: url(http://sanatorium-pridneprovsky.by/img/before_calc_bg.jpg);
