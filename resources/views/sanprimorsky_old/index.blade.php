...
<head>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-T3QFNW9');</script>
    <!-- End Google Tag Manager -->

</head>
<body>

<header id="top" class="leto">
    ...
    <div class="row-fluid">
        <div class="container">
            <div class="col-md-12">
                <h1>Проведите отдых с пользой для здоровья </br><span> в популярном санатории Беларуси "Приморский" </span></h1>
                    ...
                    <div class="forma text-center">
                        ...
                        <div class="form-title-before">
                            <div style="padding-bottom: 1px;background: rgba(245, 247, 246, 0.8);">
                                <p style="font-size: 23px;font-family: BeauSans700;"><span style="color: red">Акция</span> до конца недели!</br>
                                    Путевки на осень 2019 <span style="color: red">со скидкой до -20%</span></p>
                            </div>
                        </div>
                        <form class="form">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="datestart" id="datep-on" class="date" placeholder="c __.__.____">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" name="datefinish" id="datep-off" class="date" placeholder="до __.__.____">
                                </div>
                            </div>
                            <div class="row-fluid">
					    ...
					    <option value="Костно-мышечные болезни">Костно-мышечные болезни</option>
                            ...
                            <div class="row-fluid">
                                <button type="submit" class="myBut">Узнать сниженную стоимость</button>
                            </div>
                            <div class="row-fluid">
...
<div class="section soveti">
    <div class="container">
        <h2 class="text-center">
            Преимущества санатория «Приморский:
        </h2>
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    ...
                    <div class="clearfix"></div>
                    <div class="desc">
                        Санаторий находится вблизи соснового леса. Хвойная терапия – тысячелетиями проверенный способ борьбы со многими болезнями, а также их своевременной профилактики. Все посетители отмечают, что
...
<!--
        <div class="section new-year">
    <div class="container">
        <div class="row-fluid">
            <div class="title text-center">
                <span class="text-bold">Специальное предложение санатория "Приморский"</span>
                <div class="clearfix"></div>
                На заезды с 8 января по 1 марта 2019 года </br></br>
                БЕСПЛАТНОЕ ПОСЕЩЕНИЕ ОДНОЙ ИЗ ПРОЦЕДУР НА ВЫБОР
            </div>
        </div>
        <div class="row-fluid">
            <div class="items-block text-center">
        ...
        <div class="row-fluid">
            <div class="form-block text-center">
                <form class="form">
                    <label>Введите номер телефона для бронирования бесплатной процедуры</label>
                    <input type="text" name="phone" class="phone" placeholder="+_(___) ___ __ __" required>
                    <input type="hidden" name="form_name" value="Новогоднее предложение">
                            <input type="hidden" id="utm_term" name="utm_term">
                            <input type="hidden" id="utm_source" name="utm_source">
                            <input type="hidden" id="utm_medium" name="utm_medium">
                            <input type="hidden" id="utm_content" name="utm_content">
                            <input type="hidden" id="utm_campaign" name="utm_campaign">
                            <input type="hidden" id="roistat" name="roistat">
                    <button type="submit" class="text-bold">Получить бесплатное посещение</button>
                </form>
                <span>Торопитесь!!! Количество акционных мест ограничено!!!</span>
            </div>
        </div>
    </div>
</div>-->
...
<!--
        ...
        <div class="container">
            <div class="row-fluid">
                <div class="title text-center">
                    <span class="text-bold"><br>АКЦИЯ В ПРИМОРСКОМ!!!<br></span>
                    <div class="clearfix"></div>
                    Прогулка на яхте по Минскому Морю </br><b>В ПОДАРОК</b><br>при покупке путёвки от <b>8 дней</b>
                </div>
            </div>
			            <div class="row-fluid">
                <div class="form-block text-center">
                    <form class="form">
                        ...
                        <input type="text" name="phone" class="phone" style="color: black;" placeholder="+_(___) ___ __ __" required>
						<input type="hidden" name="form_name" value="Акция в приморском один из трёх">
								<input type="hidden" id="utm_term" name="utm_term">
								<input type="hidden" id="utm_source" name="utm_source">
								<input type="hidden" id="utm_medium" name="utm_medium">
								<input type="hidden" id="utm_content" name="utm_content">
								<input type="hidden" id="utm_campaign" name="utm_campaign">
								<input type="hidden" id="roistat" name="roistat">
                        <button type="submit" class="text-bold">Получить подарок >>> </button>
                    </form>
                    <br>
                </div>
            </div>
                ...
                <div class="form-block text-center">
                    <form class="form">
						...
						<input type="hidden" name="form_name" value="Акция в приморском один из трёх">
								...
								<input type="hidden" id="utm_campaign" name="utm_campaign">
								<input type="hidden" id="roistat" name="roistat">
                        <button type="submit" class="text-bold">Забронировать по акции >></button>
                    </form>
                    <br>
                </div>
            </div>
...
<div class="section calc">
    <div class="container">
        ...
        <div class="calc-form">
            <form class="form">
                <input type="hidden" name="form_name" value="Форма калькулятора">
                <input type="hidden" id="utm_term" name="utm_term">
                <input type="hidden" id="utm_source" name="utm_source">
                <input type="hidden" id="utm_medium" name="utm_medium">
                <input type="hidden" id="utm_content" name="utm_content">
                <input type="hidden" id="utm_campaign" name="utm_campaign">
                <input type="hidden" id="roistat" name="roistat">
                <div class="form-container leto text-center">
                    <div class="title">
                        Заполните данные и <span>получите расчет стоимости</br>
                            путевки с лечением</span>:
                    </div>
                    <div id="step-one" class="step active">
                        <div class="step-name">
                            1. Выберите количество человек и возраст<br>
                            <span>Мы подберем развлечение и программу лечения специально под Вас и подберем подходящие номера для проживания</span>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-sm-6">
                                    ...
                                    <div class="clearfix row-select"></div>
                                    <select name="baby-val" class="select baby">
                                        <option value="Без детей">Без детей</option>
                                        <option value="1 ребенок">1 ребенок</option>
                                        <option value="2 детей">2 детей</option>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="adge_people" class="inputs" placeholder="Введите возраст взрослых">
                                    <div class="clearfix row-select"></div>
                                    <input type="text" name="adge_baby" class="inputs" placeholder="Введите возраст детей">
                                </div>
                            </div>
                        </div>
                        <div class="buttons">
                            <button id="step2" class="step-next">Далее</button>
                        </div>
                    </div>

                    <div id="step-two" class="step">
                        <div class="step-name">
                            2. Выберите лечебный профиль, можно несколько<br>
                            <span>Мы подберём программу лечения максимально настроенную на Ваше оздоровление. Нажмите на нужные профили:</span>
                        </div>
                        <div class="row-fluid">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="odp" name="odp" value="Опорно-двигательный аппарат"><label for="odp"><span>Опорно-двигательный аппарат</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="org_dih" name="org-dih" value="Органы дыхания"><label for="org_dih"><span>Органы дыхания</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="org_dih2" name="org_dih2" value="Сердечно-сосудистая система"><label for="org_dih2"><span>Сердечно-сосудистая система</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="vdp" name="vdp" value="Верхние дыхательные пути"><label for="vdp"><span>Верхние дыхательные пути</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="zkt" name="zkt" value="Органы ЖКТ"><label for="zkt"><span>Органы ЖКТ</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="ns" name="ns" value="Нервная система"><label for="ns"><span>Нервная система</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="obsh_prof" name="obsh_prof" value="Общетерапевтический профиль"><label for="obsh_prof"><span>Общетерапевтический профиль</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="op" name="op" value="Органы пищеварения"><label for="op"><span>Органы пищеварения</span></label>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <input type="checkbox" id="kmb" name="kmb" value="Костно-мышечные болезни"><label for="kmb"><span>Костно-мышечные болезни</span></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="step-three" class="step">
                        <div class="step-name">
                            3. Выберите примерную дату отдыха<br>
                            <span>Мы подберём заселение и количество процедур исходя из количества дней Вашего отдыха</span>
                        </div>
                        <div class="row-fluid">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="label">Примерная дата заселения</div>
                                        <input type="text" name="datestart" id="datep-on2" class="date" placeholder="c __.__.____">
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="label">Примерная дата отъезда</div>
                                        <input type="text" name="datefinish" id="datep-off2" class="date" placeholder="до __.__.____">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="step-thour" class="step">
                        <div class="col-sm-8 col-sm-offset-2 step-name">
                            4. Если знаете, выберете примерный бюджет в росс. руб.:
                        </div>
                        <div class="row-fluid">
                            <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                                <div class="row range-slider">
                                    <div class="col-xs-6">
                                        От <input id="price" type="text" name="price-start">
                                    </div>
                                    <div class="col-xs-6">
                                        До <input id="price2" type="text" name="price-finish">
                                    </div>
                                    <div class="col-xs-12">
                    ...
                    <div id="step-five" class="step">
                        <div class="col-xs-12 step-name">
                            5. Выберите способ для связи с Вами<br>
                            <span>Мы подберем программу отдыха по заполненным параметрам и свяжемся с Вами для консультации. <span>Выбкрите как с Вами связаться:</span></span>
                        </div>
                        <div class="row-fluid">
                            <div class="col-xs-12">
                        ...
                        <div class="row-fluid type-svias">
                            <label>Введте Ваш номер телефона:</label>
                            <div class="clearfix"></div>
...
<!--
<div class="section fotoparthner text-center">
		    ...
		    <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="item">
                        <div class="title">
                            <div class="text">
                                Новый современный центр
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="desc">
                            Строительство республиканского центра завершено в 2018 году. На него потратили более 100 миллионов долларов, оснастили самым современным медицинским оборудованием и собрали лучших врачей страны.
                            <span>Благодаря партнёрству с президентским центром, у гостей нашего санатория есть прекрасная возможность оздоравливаться в лучшем лечебном учреждении Беларуси.</span>
                        </div>
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="item">
                        ...
                        <div class="clearfix"></div>
                        <div class="desc">
                            Ресубликанский клинический центр находится в 10 км. от санатория "Приморский". Добраться до лечебного центра можно на регулярном рейсовом автобусе. Кроме того, <span>наши зарубежные гости обслуживаются по приоритетной предварительной записи</span>.
                         Наши гости ценят такую возможность!
						</div>
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="item">
                        ...
                        <div class="clearfix"></div>
                        <div class="desc">
                             Благодаря единому государственному регулированию цен, стоимость процедур в президентском центре остаётся на уровне республиканских.
                            <span>Отдыхая в нашем санатории Вы получаете доступ к самому качественному лечению по самым доступным ценам.</span>
                        </div>
                    </div>
                </div>
			</div>
			<button class="spisokproc" data-toggle="modal" data-target="#spisokproc">Получить посещение без очереди</button>
		</div>
	</div>
</div>
-->
<div class="section foto text-center">
    <div class="container">
        ...
        <div class="description">
            <span>В нашем санатории вы можете сделать общий анализ крови, ультразвуковую, лабораторную диагностику в 3-5 раз дешевле чем в России.</span><br>
...
<!--
    <div class="section best-programms">
        <div class="container">
            <h2 class="text-center">
                Самые популярные лечебные программы санатория "Приморский"
            </h2>
            <div class='row'>
                <div class='col-md-6'>
                        <div class='item-prog'>
                        <div class='left-block'>
                            <img src='img/pozvono4nik.png' alt='Программа здоровый позвоночник в санатории Приморский'>
                            <form action='programms/pozvono4nik.php' method='post' class='form-best-prog'>
                                <label>
                                    <span class='meil'>Ваш номер телефона*:</span>
                                    <input type='phone' name='phone' required='required'>
									<input type="hidden" name="form_name" value="Программа Здоровый позвоночник">
									<input type="hidden" id="utm_term" name="utm_term">
									<input type="hidden" id="utm_source" name="utm_source">
									<input type="hidden" id="utm_medium" name="utm_medium">
									<input type="hidden" id="utm_content" name="utm_content">
                                ...
                                <button type='submit' class='green-button'>Подробнее</button>
                            </form>
                        </div>
                        <div class='right-block'>
                            <div class='likes'>
                                <img src='img/active_like.png' alt='сердце'>
                                <img src='img/active_like.png' alt='сердце'>
                                <img src='img/active_like.png' alt='сердце'>
                                <img src='img/active_like.png' alt='сердце'>
                            </div>
                            <h3>Программа<br><span>"Здоровый позвоночник"</span></h3>
                            <h4>Показания:</h4>
                            <ul>
                                <li>Остеохондроз позвоночника.</li>
                            </ul>
                            <h4>Ожидаемыйй эффект:</h4>
                            <ul>
                                <li>Уменьшение болей в проблемных зонах позвоночника.</li>
                            </ul>
                        </div>
                    </div>
                    <div class='item-prog'>
                        <div class='left-block'>
                            <img src='img/immuno.png' alt='Программа Иммуностимулирующая в санатории Приморский'>
                            <form action='programms/immuno.php' method='post' class='form-best-prog'>
                                <label>
                                    <span class='meil'>Ваш номер телефона*:</span>
                                    <input type='phone' name='phone' required='required'>
									<input type="hidden" name="form_name" value="Программа Иммуностимулирующая">
									<input type="hidden" id="utm_term" name="utm_term">
									<input type="hidden" id="utm_source" name="utm_source">
									<input type="hidden" id="utm_medium" name="utm_medium">
									<input type="hidden" id="utm_content" name="utm_content">
                        ...
                        <div class='right-block'>
                            ...
                            <h3>Программа<br><span>"Иммуностимулирующая"</span></h3>
                            <h4>Показания:</h4>
                            <ul>
                                <li>Частые простудные заболевания.</li>
                                <li>Частые обострения хронических заболеваний.</li>
                            </ul>
                            <h4>Ожидаемыйй эффект:</h4>
                            <ul>
                                <li>Уменьшение клинических проявлений основных заболеваний.</li>
                                <li>Улучшение самочувствия.</li>
                                <li>Уменьшение случаев острых вирусных инфекций.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class='col-md-6'>
                        <div class='item-prog'>
                        <div class='left-block'>
                            <img src='img/zdorovie.png' alt='Программа будь здоров в санатории Приморский'>
                            <form action='programms/be_healthy.php' method='post' class='form-best-prog'>
                                <label>
                                    <span class='meil'>Ваш номер телефона*:</span>
                                    <input type='phone' name='phone' required='required'>
									<input type="hidden" name="form_name" value="Программа Будь Здоров">
									<input type="hidden" id="utm_term" name="utm_term">
									<input type="hidden" id="utm_source" name="utm_source">
									<input type="hidden" id="utm_medium" name="utm_medium">
									<input type="hidden" id="utm_content" name="utm_content">
                        ...
                        <div class='right-block'>
                            ...
                            <h3>Программа<br><span>"Будь здоров"</span></h3>
                            <h4>Показания:</h4>
                            <ul>
                                <li>Укрепление и улучшение иммунитета у детей.</li>
                                <li>Острые вирусные и простудные заболевания, часто рецидивирующие.</li>
                                <li>Хронические заболевания верхних дыхательных путей (ринит, синусит, фарингит, тонзиллит, ларингит, бронхит).</li>
                            </ul>
                            <h4>Ожидаемыйй эффект:</h4>
                            <ul>
                                <li>Уменьшение частоты обострений рецидивирующих заболеваний.</li>
                                <li>улучшение имунного статуса ребёнка.</li>
                                <li>Улучшение самочувствия.</li>
								<li>Уменьшение случаев острых вирусных заболеваний.</li>
                            </ul>
                        </div>
                    </div>
                    <div class='item-prog'>
                        <div class='left-block'>
                            <img src='img/antistress.png' alt='Программа антистресс в санатории Приморский'>
                            <form action='programms/antistress.php' method='post' class='form-best-prog'>
                                <label>
                                    <span class='meil'>Ваш номер телефона*:</span>
                                    <input type='phone' name='phone' required='required'>
									<input type="hidden" name="form_name" value="Программа Антистресс">
									<input type="hidden" id="utm_term" name="utm_term">
									<input type="hidden" id="utm_source" name="utm_source">
									<input type="hidden" id="utm_medium" name="utm_medium">
									<input type="hidden" id="utm_content" name="utm_content">
                        ...
                        <div class='right-block'>
                            ...
                            <h3>Программа<br><span>"Антистресс"</span></h3>
                            <h4>Показания:</h4>
                            <ul>
                                <li>Вегетативная дистония.</li>
                                <li>Хроническая усталость.</li>
                            </ul>
                            <h4>Ожидаемый эффект:</h4>
                            <ul>
                                <li>Повышение активности и жизненного тонуса.</li>
                                <li>Уменьшение невротических проявлений.</li>
                                <li>Улучшение сна, настроения.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row-fluid">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <select name="profile">
                                    ...
                                    <option value="Общетерапевтический профиль">Общетерапевтический профиль</option>
                                    <option value="Органы пищеварения">Органы пищеварения</option>
                                    <option value="Костно-мышечные болезни">Костно-мышечные болезни</option>                                    </select>
                            </div>
                        </div>
                        <div class="row-fluid">
                            <label>Выберите количество отдыхающих:</label>
...
<div class="section contacts">
    ...
    <div class="map">
        <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A9603e5271d8a98df6db1ceb4cc75bbf4813aa05f0441add047f5ee2342e75839&amp;width=100%25&amp;height=400&amp;lang=ru_RU&amp;scroll=true"></script>
    </div>
</div>
...
<!--    <a href="http://primorsky.sanatoriumbel.by/" target="_blank"><button id="BuyButton" class="plav pulse visible-md visible-lg" style="background: #03b97f;border: 2px solid #019667; top:110px;"><b style="color:white; top: 110px;">Сэкономьте 10%, купив путёвку онлайн</b></button></a>-->


<div class="modal fade" id="webpay_uslovia" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="modal-title text-center">
                <span class="text-bold">Условия оплаты</span>
            </div>
            <div class="form-modal">
                <h3>Процесс заказа</h3>
                <p>Подберите путевку в конструкторе путевок, для этого:
                <ul>
                    <li>выберите даты</li>
                    <li>укажите количество людей</li>
                    <li>укажите количество детей и возраст</li>
                    <li>выберите номер</li>
                    <li>проверьте информацию и сумму оплаты</li>
                    <li>введите данные клиента</li>
                ...
                <p>В случае, если Вы не получили заказ (не оказана услуга), Вам необходимо обратиться в службу клиентского сервис по телефонам +37529 380-7873 или e-mail info.sanatorium@gmail.com. Менеджеры Вас проконсультируют.</p>

                <h3>Документ подтверждения оплаты</h3>
                <p>После оплаты вам на email придет электронный чек и путевка.
                    Оразец:<br><br>
                    <img src="/images/putevka_600.jpg" alt="" style="max-width: 100%">
                </p>
...
<div class="modal fade" id="consult" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="modal-title text-center">
                <span class="text-bold">Бесплатная консультация с представителем Приморского санатория</span>
                <div class="clearfix"></div>
                Заполните контактные данные и мы свяжемся с вами в течение 10 минут:
            </div>
            <div class="form-modal">
                <form class="form">
                    <input type="hidden" name="form_name" value="Форма Получить консультацию">
                    <input type="hidden" id="utm_term" name="utm_term">
                    <input type="hidden" id="utm_source" name="utm_source">
                    <input type="hidden" id="utm_medium" name="utm_medium">
                    <input type="hidden" id="utm_content" name="utm_content">
...
<div class="modal fade" id="action" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="modal-title text-center">
                <span class="text-bold">Введите Ваш номер телефона. </br>Наш менеджер свяжется с Вами и сообщит цену на подходящие Вам даты.</span>
            </div>
            <div class="form-modal">
                <form class="form">
                    <input type="hidden" name="form_name" value="Узнать цены">
                    <input type="hidden" id="utm_term" name="utm_term">
                    <input type="hidden" id="utm_source" name="utm_source">
                    <input type="hidden" id="utm_medium" name="utm_medium">
                    <input type="hidden" id="utm_content" name="utm_content">
                    ...
                    <!--              <label>Ваш E-mail</label>
                                  ...
                                  <label>Номер телефона</label>-->
                    <input type="text" name="phone" class="phone" placeholder="+_(___) ___ __ __" required>
                    <button type="submit" class="text-bold">Узнать цены</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="spisokproc" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="modal-title text-center">
                <span class="text-bold">Забронируйте посещение президентского мед. центра без очереди. Оставьте свой номер телефона. Он буде служить промокодом.</span>
            </div>
            <div class="form-modal">
                <form class="form">
                    <input type="hidden" name="form_name" value="Получить список процедур Леч.комиссии">
                    <input type="hidden" id="utm_term" name="utm_term">
                    <input type="hidden" id="utm_source" name="utm_source">
                    <input type="hidden" id="utm_medium" name="utm_medium">
                    <input type="hidden" id="utm_content" name="utm_content">
                    ...
                    <label>Номер телефона</label>
                    <input type="text" name="phone" class="phone" placeholder="+_(___) ___ __ __" required>
                    <button type="submit" class="text-bold">Получить список процедур</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="callback" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="modal-title text-center">
                <span class="text-bold">Введите свой номер телефона, наш специалист свяжется с Вами и ответит на все Ваши вопросы.</span>
            </div>
            <div class="form-modal">
                <form class="form">
                    <input type="hidden" name="form_name" value="Колбек">
                    <input type="hidden" id="utm_term" name="utm_term">
                    <input type="hidden" id="utm_source" name="utm_source">
                    <input type="hidden" id="utm_medium" name="utm_medium">
                    <input type="hidden" id="utm_content" name="utm_content">
                    ...
                    <label>Номер телефона</label>
                    <input type="text" name="phone" class="phone" placeholder="+_(___) ___ __ __" required>
                    <button type="submit" class="text-bold">Свяжитесь со мной</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="otziv" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="modal-title text-center">
                <span class="text-bold">Получайте новые акции, скидки санатория «Приморский» прямо на почту</span>
            </div>
            <div class="form-modal">
                <form class="form">
                    <input type="hidden" name="form_name" value="Форма отзыва">
                    <input type="hidden" id="utm_term" name="utm_term">
                    <input type="hidden" id="utm_source" name="utm_source">
                    <input type="hidden" id="utm_medium" name="utm_medium">
                    <input type="hidden" id="utm_content" name="utm_content">
                    ...
                    <textarea name="text-otziv" required></textarea>
                    <button type="submit" class="text-bold">Отправить отзыв</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    {location.hash.substr(3).split("&").forEach(function(item) {utm[item.split("=")[0]] = decodeURIComponent(item.split("=")[1])});}
    else {location.search.substr(1).split("&").forEach(function(item) {utm[item.split("=")[0]] = decodeURIComponent(item.split("=")[1])});}


    for (var i=0; i <document.getElementsByName('utm_term').length; i++) {
        document.getElementsByName('utm_term')[i].value = utm.utm_term;
    }

    for (var i=0; i <document.getElementsByName('utm_source').length; i++) {
        document.getElementsByName('utm_source')[i].value = utm.utm_source;
    }

    for (var i=0; i <document.getElementsByName('utm_medium').length; i++) {
        document.getElementsByName('utm_medium')[i].value = utm.utm_medium;
    }

    for (var i=0; i <document.getElementsByName('utm_content').length; i++) {
        document.getElementsByName('utm_content')[i].value = utm.utm_content;
    }

    for (var i=0; i <document.getElementsByName('utm_campaign').length; i++) {
        document.getElementsByName('utm_campaign')[i].value = utm.utm_campaign;
    }
</script>
...
<noscript><div><img src="https://mc.yandex.ru/watch/47736742" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</script>
<!--<script type="text/javascript" src="//cdn.callbackhunter.com/cbh.js?hunter_code=433f4f1b1d6ba4f061d9d9318e4bf75e" charset="UTF-8"></script>-->
<!-- Callback -->
<div class="callback hidden-xs">
    <a class="callback_link" data-toggle="modal" data-target="#callback">
...
})(window, document, 'script', 'cloud.roistat.com', '0232b2903268c8cc0e5417bb1f21bce6');
</script>
-->
<!--<script>
...
for (var i=0; i <document.getElementsByName('utm_term').length; i++) {
document.getElementsByName('roistat')[i].value = getCookie("roistat_visit");
}
</script>-->

<!-- Google Tag Manager (noscript)
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T3QFNW9"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>-->

<!--<script type="text/javascript">-->
<!--    $(document).mousemove(function(e){-->
<!--        if (e.clientY < 10 && localStorage.getItem('sendLead') == null) {-->
<!--            $(".exitblock").fadeIn("fast");-->
<!--            $(".exitblock").css('overflow','show');-->
<!--        }-->
<!--    });-->
...
<!--        let it = $(this);-->
<!--        let buttonname = it.find("button[type='submit']").text();-->
<!--        it.find("button[type='submit']").text('Загрузка...');-->
<!--        setTimeout(function() {-->
<!--            it.find("button[type='submit']").text(buttonname);-->
<!--        }, 5000);-->
<!--        localStorage.setItem('sendLead', true);-->
<!--        return true;-->
<!--    });-->
<!--</script>-->
...
<!--            <div class="div-block-5"><h3 class="heading-2">Туры в Приморский<br>с гарантированной</h3><h3 class="heading-3">скидкой 20%</h3><br>-->
<!--                <a href="http://primorsky.sanatoriumbel.by/" class="button w-button" target="_blank">Узнать цены на туры</a>-->
<!--            </div>-->

<!--            &lt;!&ndash;<div class="modal-title text-center">-->
<!--                <span class="text-bold">Выберите тур в санаторий "Приморский" с гарантированной скидкой 20%</span>-->
<!--                <img src="img/2.png" class="rounded mx-auto d-block img-fluid" alt="" >-->
<!--            </div>-->
<!--            <div class="form-modal">-->
<!--            <button type="submit" class="text-bold" onclick='$(".exitblock").fadeOut("fast");window.open("http://primorsky.sanatoriumbel.by/");'>Узнать цены на туры</button>-->
<!--              <form action="amocrm/scripts/sPulse/fromsite.php" method="post">-->
<!--                    <label>Ваш e-mail</label>-->
<!--                    <input type="email" name="email" class="email" placeholder="my@email.ru" required>-->
<!--                    <button type="submit" class="text-bold" onclick='$(".exitblock").fadeOut("fast");'>Скачать</button>-->
<!--                </form>-->
<!--            </div>-->
<!--        </div>&ndash;&gt;-->
<!--        </div>-->
...
<!--модальное окно рабочее начало-->
<div class="modal fade" id="global-modal" role="dialog" >
    <div class="modal-dialog modal-lg" style="top: 5%;padding-left: 8%; padding-right: 8%;">
        <!--Modal Content-->
        <div class="modal-content" style="
        /*background-image: url(http://sanatorium-pridneprovsky.by/img/before_calc_bg.jpg);*/
         background: #2193b0;  /* fallback for old browsers */
background: -webkit-linear-gradient(to bottom, #FFFAFA, #ffffff);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to bottom, #FFFAFA, #ffffff); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
border: none;
">

            <div class="modal-header" style="border-bottom: 0px solid #e5e5e5; padding-top: 0px;">
                <button type="button" class="close" style=" font-size: 28px;" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" style="padding-bottom: 20px">×</span>
                </button>
            </div>
...
<!--        mouseX = e.clientX;-->
<!--        mouseY = e.clientY;-->
<!--        // document.getElementById("global-modal").innerHTML =  e.clientX + e.clientY;-->
<!--    });-->
...
<script type="text/javascript">
    ...
    _tmr.push({id: "3102375", type: "pageView", start: (new Date()).getTime(), pid: "USER_ID"});
    (function (d, w, id) {
        ...
        <img src="https://top-fwz1.mail.ru/counter?id=3102375;js=na" style="border:0;position:absolute;left:-9999px;" alt="Top.Mail.Ru" />
    </div></noscript>
<!-- //Rating@Mail.ru counter -->
<script>
    (function(w, d, s, h, id) {
